...
public class CANDriveSubsystem extends SubsystemBase {
  ...
  public void periodic() {
      double[][] data = {
        getSparkMaxData(leftLeader),
        getSparkMaxData(leftFollower),
  ...
  private double[] getSparkMaxData(SparkMax sparkMax) {
    ...
    data[1] = sparkMax.getMotorTemperature();
    data[2] = sparkMax.getEncoder().getVelocity();
    data[3] = sparkMax.getEncoder().getPosition();
    data[4] = sparkMax.getBusVoltage();
    return data;
  }
}